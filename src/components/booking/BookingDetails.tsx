...
export default function BookingDetails(): JSX.Element {
  const { booking, error } = useSelector((state: AppState) => state.bookings.bookingDetails);
        ...
        <div className="col-12 col-lg-8 mt-5 booking-details">
          {booking && booking.room && booking.user && (
            <>
              ...
              <p>
                <b>Check In:</b> {new Date(booking.checkInDate ? booking.checkInDate : 0).toLocaleString('en-US')}
              </p>

              <p>
                <b>Check Out:</b> {new Date(booking.checkOutDate ? booking.checkOutDate : 0).toLocaleString('en-US')}
              </p>
              ...
              <div className="cart-item my-1">
                <div className="row my-5">
                  <div className="col-4 col-lg-2">
                    <Image src={booking.room.images[0].url} alt={booking.room.name} height={45} width={65} />
                  </div>
